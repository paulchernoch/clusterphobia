...
use crate::data::{s1_points, s2_points};
use clusterphobia::clustering::single_linkage::SingleLinkage;

/// Test SingleLinkage::find_by_sorting against the S1 data set. 
/// 
/// This data set has better defined clusters without overlap, 
/// as compared to S2, where some clusters overlap and there is more noise. 
#[test]
fn s1_single_linkage_find_by_sorting() {
    ...
    let expected_range = 3_500_000_000..3_800_000_000_u64;
...
/// Ideally, we hope to find a place where there is a gap in distances, but there is none!
